...
public class FlatRest {
	...
	public List<Flat> viewFlats() {
		List<Flat> allFlats = this.flatService.viewAllFlat();
		return allFlats;
	}
	...
	public List<Flat> viewFlatByCostAndAvailability(@PathVariable float cost, @PathVariable String availability) {
		List<Flat> allFlatsByCostAndAvailability = this.flatService.viewAllFlatByCost(cost, availability);
	...
	public Flat updateFlat(@RequestBody Flat flat) {
		Flat flat1 = null;
		flat1 = this.flatService.updateFlat(flat);
		return flat1;
	}
	...
	public Flat deleteFlat(@RequestBody Flat flat) {
		Flat deletedFlat = this.flatService.deleteFlat(flat);
		return deletedFlat;
